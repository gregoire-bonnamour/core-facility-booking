...
from equipements.models import TarifFormation
import logging
...
def get_tarif_horaire(equipement, affiliation):
    from equipements.models import Tarif  # import local pour prévenir import circulaire
        ...
        for labo_nom, reservations in groupes_par_labo.items():
            ...
            for resa in unique_resas:
                ...
                for d in all_lines:
                    ...
                    u_labo = "Inconnu"
                    if d['usager'] and d['usager'].laboratoire:
                        u_labo = d['usager'].laboratoire.nom
    ...
    for labo, reservations in groupes_par_labo.items():
        ...
        for usager, equipements in regroupement.items():
            ...
            usagers_context.append({
                "usager": usager,
                "equipements": equipements_context,
