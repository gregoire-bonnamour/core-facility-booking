...
from equipements.models import Creneau, PlageLimite
...
class ReservationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        self.usager = kwargs.pop('usager', None)
        ...
        if self.request and self.request.user.is_authenticated:
            is_admin = self.request.user.is_staff or (hasattr(self.request.user, 'usager') and self.request.user.usager.est_admin)
